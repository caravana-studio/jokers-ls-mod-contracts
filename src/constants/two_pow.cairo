...
mod tests {
    use jokers_of_neon::constants::two_pow::{
        ...
        TWO_POW_208, TWO_POW_216, TWO_POW_224, TWO_POW_232, TWO_POW_240,
    };
    ...
    fn test_pow() {
        ...
        assert(
            two_pow(243) == 14134776518227074636666380005943348126619871175004951664972849610340958208, 'wrong 2 ** 243'
        );
        assert(
            two_pow(244) == 28269553036454149273332760011886696253239742350009903329945699220681916416, 'wrong 2 ** 244'
        );
        assert(
            two_pow(245) == 56539106072908298546665520023773392506479484700019806659891398441363832832, 'wrong 2 ** 245'
        );
        assert(
