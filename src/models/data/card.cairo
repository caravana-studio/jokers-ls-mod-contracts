...
trait CardTrait {
    ...
    fn new_neon_card(value: Value, suit: Suit, points: u32, multi: u32) -> Card;
    fn generate_neon_id(value: Value, suit: Suit) -> u32;
}
...
impl CardImpl of CardTrait {
    ...
    fn new_neon_card(value: Value, suit: Suit, points: u32, multi: u32) -> Card {
        let suit_u8: u8 = suit.into();
        let value_u8: u8 = value.into();
        Card { id: 200 + ((13 * (suit_u8 - 1)) + (value_u8 - 1)).into(), suit, value, points, multi_add: multi }
    }

    fn generate_neon_id(value: Value, suit: Suit) -> u32 {
        let suit_u8: u8 = suit.into();
        let value_u8: u8 = value.into();
        200 + ((13 * (suit_u8 - 1)) + (value_u8 - 1)).into()
    }
}
